    ...
    <section className="relative z-10 flex h-screen flex-col items-center justify-center px-6 py-16 text-white pointer-events-none">
      <div className="mx-auto flex w-full max-w-4xl flex-col items-center gap-12 text-center">
        ...
        <img
          ...
          className="pointer-events-auto h-[250px] w-[250px] rounded-full border border-white/30 bg-white/10 object-cover shadow-[0_12px_40px_rgba(0,0,0,0.8)] transition-transform duration-500 hover:scale-105"
        />
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 text-2xl font-bold text-white sm:text-4xl">
          ...
          <RotatingText
            ...
            mainClassName="pointer-events-none inline-flex items-center justify-center overflow-hidden rounded-2xl bg-[#1a1a1a] px-5 py-2 text-center shadow-[0_16px_36px_rgba(0,0,0,0.6)]"
            staggerFrom="last"
          ...
          {SOCIAL_LINKS.map((link) => {
            ...
            return (
              <a
                ...
                className="pointer-events-auto inline-flex h-12 w-12 items-center justify-center rounded-full border border-white/25 bg-white/5 text-white/80 shadow-[0_10px_30px_rgba(0,0,0,0.5)] transition-all duration-300 hover:-translate-y-1 hover:border-white/50 hover:bg-white/10 hover:text-white"
              >
