        ...
        >
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full rounded-2xl border border-white/10 bg-white/5 px-4 py-2.5 text-sm text-white/90 placeholder:text-white/30 transition focus:border-white/60 focus:outline-none focus:ring-2 focus:ring-white/10"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="w-full rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-white/90 placeholder:text-white/30 transition focus:border-white/60 focus:outline-none focus:ring-2 focus:ring-white/10"
            />
          </div>

          <button
            type="submit"
            className="relative w-full overflow-hidden rounded-full border border-white/20 bg-white/5 px-5 py-3 text-base font-semibold text-white shadow-sm transition-all duration-200 hover:bg-white/10 hover:border-white/40 focus:outline-none focus:ring-2 focus:ring-white/20 disabled:cursor-not-allowed disabled:opacity-75"
          ...
          >
            ...
            >
              <span
                className="absolute inset-y-0 left-0 bg-white/10 transition-[width] duration-150 ease-out"
